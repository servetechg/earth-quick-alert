...
const GasSiteSchema = new Schema(
    {
...
const ResponderGasDeploymentSchema = new Schema(
    {
        ...
        sites: { type: [GasSiteSchema], default: [] },
...
if (process.env.NODE_ENV !== 'production' && models.ResponderGasDeployment) {
    delete models.ResponderGasDeployment;
}

const ResponderGasDeployment =
    models.ResponderGasDeployment || model('ResponderGasDeployment', ResponderGasDeploymentSchema);

export default ResponderGasDeployment;
