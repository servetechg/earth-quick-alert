...
import { Loader2, Save, MapPin, Users, Plus, Trash2, Edit, Package, Navigation } from 'lucide-react'
...
function normalizePayload(payload: FoodLogisticsResourceDeploymentPayload): FoodLogisticsResourceDeploymentPayload {
  return {
    ...payload,
