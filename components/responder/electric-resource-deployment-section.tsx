...
import { Loader2, Save, MapPin, Zap, Plus, Trash2, Edit, HardHat, Truck, Navigation } from 'lucide-react'
...
function normalizePayload(payload: ElectricResourceDeploymentPayload): ElectricResourceDeploymentPayload {
  return {
    ...payload,
