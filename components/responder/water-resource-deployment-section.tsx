...
import { Loader2, Save, MapPin, Droplets, Plus, Trash2, Edit, HardHat, Navigation } from 'lucide-react'
...
function normalizePayload(payload: WaterResourceDeploymentPayload): WaterResourceDeploymentPayload {
  return {
    ...payload,
