...
export const DEMO_CRITICAL_INFRA_MARKERS: CriticalInfraMapMarker[] = [
  ...
  },
  {
    ...
    lat: 34.735,
    lng: -92.222,
    title: 'Little Rock Heavy Industrial Foundry',
    status: 'at_risk',
    location: 'East Little Rock, AR',
    description: 'Heavy machinery fabrication — power supply flickering; structural checks pending.',
    riskLevel: 'HIGH',
  },
  {
    id: 'ci-demo-def-1',
    ...
    lat: 34.825,
    lng: -92.295,
    title: 'Camp Joseph T. Robinson (AR National Guard)',
    status: 'operational',
    location: 'North Little Rock, AR',
    description: 'Primary defense support of civil authorities (DSCA) staging area.',
    riskLevel: 'LOW',
  },
  {
    id: 'ci-demo-it-1',
    ...
    lat: 34.755,
    lng: -92.278,
    title: 'Downtown Arkansas Data Center Hub',
    status: 'at_risk',
    location: 'Little Rock, AR',
    description: 'Critical communications routing hub; running on backup diesel generators.',
    riskLevel: 'HIGH',
  },
  {
    id: 'ci-demo-nuc-1',
    ...
    lat: 34.741,
    lng: -92.312,
    title: 'Arkansas Nuclear Regulatory & Medical Materials Depot',
    status: 'operational',
    location: 'Little Rock, AR',
