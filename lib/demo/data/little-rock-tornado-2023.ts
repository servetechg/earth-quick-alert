...
export const DEMO_CITIZEN_MARKERS = [
    {
        ...
        location: 'Chenal Valley, Little Rock, AR',
        description: 'Trapped on 2nd floor — roof collapse; needs immediate evacuation.',
    },
    {
        id: 'demo-cit-2',
        lat: 34.768,
        ...
        isSafe: false,
        status: 'help' as const,
        location: 'Breckenridge, Little Rock, AR',
        description: 'Medical assistance — diabetic, insulin supply destroyed.',
    },
    {
        id: 'demo-cit-3',
        lat: 34.785,
        ...
        isSafe: false,
        status: 'help' as const,
        location: 'Amboy, North Little Rock, AR',
        description: 'Family of 4 sheltering in basement — water rising, request rescue.',
    },
    {
        id: 'demo-cit-4',
        lat: 34.812,
        ...
        description: 'Checked in safe at community shelter.',
    },
    {
        id: 'demo-cit-5',
        lat: 34.858,
        ...
        description: 'Elderly couple isolated — downed trees blocking driveway, no power.',
    },
    {
        id: 'demo-cit-6',
        lat: 34.771,
        ...
        description: 'Structure damage — request welfare check and temporary shelter.',
    },
] as const;
...
export const DEMO_RESPONDER_MARKERS = [
    {
        ...
        title: 'LRFD Engine 9',
        status: 'deployed',
        location: 'Breckenridge corridor, Little Rock',
        description: 'Little Rock Fire — search & rescue along Chenal Parkway.',
    },
    {
        id: 'demo-res-2',
        lat: 34.765,
        lng: -92.36,
        title: 'NLR EMS Task Force',
        status: 'active',
        location: 'Cammack Village staging',
        description: 'North Little Rock EMS — mass-casualty triage and transport.',
    },
    {
        id: 'demo-res-3',
        lat: 34.79,
        lng: -92.26,
        title: 'Amboy SAR Unit',
        status: 'active',
        location: 'Amboy, North Little Rock, AR',
        description: 'Urban search team clearing residential blocks.',
    },
    {
        id: 'demo-res-4',
        lat: 34.805,
        lng: -92.23,
        title: 'Sherwood Police EOC Liaison',
        status: 'deployed',
        location: 'Sherwood, AR',
        description: 'Traffic control and corridor security on US-67.',
    },
    {
        id: 'demo-res-5',
        lat: 34.865,
        lng: -92.12,
        title: 'Jacksonville SAR',
        status: 'active',
        location: 'Jacksonville, AR',
        description: 'Lonoke County SAR — east-track debris search.',
    },
    {
        id: 'demo-res-6',
        lat: 34.748,
        lng: -92.44,
        title: 'Arkansas DEM Mobile EOC',
        status: 'deployed',
        location: 'West Little Rock command post',
        description: 'State coordination — resource requests and shelter ops.',
    },
] as const;
