...
export async function GET() {
    try {
        ...
        console.error('Fetch ContinuityPlans error:', error);
...
export async function PUT(req: Request) {
    try {
        ...
        console.error('ContinuityPlan PUT error:', error);
...
export async function PATCH(req: Request) {
    try {
        ...
        console.error('ContinuityPlan PATCH error:', error);
        return NextResponse.json({ success: false, error: 'Internal Server Error' }, { status: 500 });
    }
}
...
export async function POST(req: Request) {
    try {
        ...
        try {
            ...
            console.error('ContinuityPlan upload text extract:', extractErr);
        }
        ...
        try {
            ...
            console.error('ContinuityPlan upload metadata inference:', metaErr);
            metadata = null;
        }
