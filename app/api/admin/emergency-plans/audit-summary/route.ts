...
import ContinuityAudit from '@/models/ContinuityAudit';
...
/** Returns the cached audit summary. Does NOT call OpenAI. */
export async function GET() {
    try {
        ...
        await connectDB();
        const cached = await ContinuityAudit.findOne({ scope: 'global' }).lean<Record<string, unknown> | null>();
...
/** Regenerates the audit summary against the current inventory and persists it. */
